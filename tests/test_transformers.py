...
class TestTransformers(unittest.TestCase):
    ...
    def test_image_random_crop(self):
        ...
        expected.putdata(
            [self.red_pixel, self.red_pixel, self.red_pixel, self.green_pixel]
        )
    ...
    def test_image_rotate_90(self):
        ...
        with mock.patch("numpy.random.choice", lambda x: x[2]):
            ...
            expected = Image.new("RGB", (2, 2))
            expected.putdata(
                [self.green_pixel, self.red_pixel, self.red_pixel, self.red_pixel]
            )
            self.assertEqual(expected, output)
    ...
    def test_tensor_normalize_tensor_2d(self):
        ...
        args1 = Args()
        args1.img_mean = [2.0, 2.0]
        args1.img_std = [2.0, 2.0]
