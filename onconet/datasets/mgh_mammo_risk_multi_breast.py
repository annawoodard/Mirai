...
class MGH_Mammo_1Year_Risk_Multi_Breast(Abstract_MGH_Mammo_Risk_Multi_Breast_Dataset):
    ...
    def __init__(self, args, transformer, split_group):
        ...
        self.years = 1
        super(MGH_Mammo_1Year_Risk_Multi_Breast, self).__init__(
            args, transformer, split_group
        )


@RegisterDataset("mgh_mammo_2year_risk_multi_breast_exlude_1yr")
class MGH_Mammo_2Year_Risk_Multi_Breast_Exclude_1Year(
    Abstract_MGH_Mammo_Risk_Multi_Breast_Dataset
):
    ...
    def __init__(self, args, transformer, split_group):
        ...
        self.years = 2
        super(MGH_Mammo_2Year_Risk_Multi_Breast_Exclude_1Year, self).__init__(
            args, transformer, split_group
        )
...
class MGH_Mammo_2Year_Risk_Multi_Breast(Abstract_MGH_Mammo_Risk_Multi_Breast_Dataset):
    ...
    def __init__(self, args, transformer, split_group):
        ...
        self.years = 2
        super(MGH_Mammo_2Year_Risk_Multi_Breast, self).__init__(
            args, transformer, split_group
        )
...
class MGH_Mammo_3Year_Risk_Multi_Breast(Abstract_MGH_Mammo_Risk_Multi_Breast_Dataset):
    ...
    def __init__(self, args, transformer, split_group):
        ...
        self.years = 3
        super(MGH_Mammo_3Year_Risk_Multi_Breast, self).__init__(
            args, transformer, split_group
        )
