...
DENSITY_BREAKDOWN_MSG = (
    "Number of 0: {}, number of 1: {}, number of 2: {}, number of 3: {}"
)

EXAM_INFORMATION_COLUMNS = {"density": 11, "png_paths": 14, "accession_id": 9}
...
class Abstract_Detroit_Mammo_Density_Dataset(Abstract_Onco_Dataset):
    def create_dataset(self, split_group, img_dir):
        ...
        print(
            DENSITY_BREAKDOWN_MSG.format(
                zero_density, one_density, two_density, three_density
            )
        )
...
class Detroit_Mammo_Binary_Density(Abstract_Detroit_Mammo_Density_Dataset):
    ...
    def __init__(self, args, transformer, split_group):
        ...
        constructs: standard pytorch Dataset obj,which can be fed in a DataLoader for batching
        """
        super(Detroit_Mammo_Binary_Density, self).__init__(
