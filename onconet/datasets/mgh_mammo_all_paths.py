...
class MGH_Mammo_All_Paths_Dataset(Abstract_Onco_Dataset):
    ...
    def create_dataset(self, split_group, img_dir):
        ...
        precomputed_hiddens_paths = (
            pickle.load(open(self.args.hiddens_results_path, "rb"))[
                "{}_hiddens".format(split_group)
            ][1]
            if self.args.use_precomputed_hiddens_in_get_hiddens
            else []
        )
