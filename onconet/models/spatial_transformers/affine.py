...
class AffineSpatialTransformer(nn.Module):
    def __init__(self, args):
        ...
        loc_net_args.pool_name = (
            MULTI_IMG_LOC_NET_POOL_NAME
            if args.multi_image
            else SINGLE_IMG_LOC_NET_POOL_NAME
        )
        ...
        self.fc_loc = nn.Linear(
            loc_net_args.hidden_dim // args.num_images, NUM_PARAMS_FOR_AFFINE_TRANSFORM
        )
