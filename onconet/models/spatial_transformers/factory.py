...
NO_SPATIAL_TRANSFORMER_ERR = (
    "Pool {} not in SPATIAL_TRANSFORMER! Available spatial transformers are {}"
)
...
def get_spatial_transformer(st_name):
    ...
    if st_name not in SPATIAL_TRANSFORMER_REGISTRY:
        raise Exception(
            NO_SPATIAL_TRANSFORMER_ERR.format(
