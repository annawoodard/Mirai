...
class Default_VGG11(nn.Module):
    def __init__(self, args):
        ...
        self._model = torchvision.models.vgg11(pretrained=args.pretrained_on_imagenet)
...
class Default_VGG19(nn.Module):
    def __init__(self, args):
        ...
        self._model = torchvision.models.vgg19(pretrained=args.pretrained_on_imagenet)
        args.wrap_model = True
