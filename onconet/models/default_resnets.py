...
def load_pretrained_model(name):
    ...
    for key in state_dict.keys():
        if "layer" not in key and "fc" not in key:
            """
...
class Default_Resnet18(nn.Module):
    def __init__(self, args):
        ...
        if args.pretrained_on_imagenet:
            load_pretrained_weights(self._model, load_pretrained_model("resnet18"))
...
class Default_Resnet34(nn.Module):
    def __init__(self, args):
        ...
        self._model = ResNet(layers, args)
        if args.pretrained_on_imagenet:
            load_pretrained_weights(self._model, load_pretrained_model("resnet34"))
...
class Default_Resnet50(nn.Module):
    def __init__(self, args):
        ...
        self._model = ResNet(layers, args)
        if args.pretrained_on_imagenet:
            load_pretrained_weights(self._model, load_pretrained_model("resnet50"))
...
class Default_Resnet101(nn.Module):
    def __init__(self, args):
        ...
        self._model = ResNet(layers, args)
        if args.pretrained_on_imagenet:
            load_pretrained_weights(self._model, load_pretrained_model("resnet101"))
...
class Default_Resnet152(nn.Module):
    def __init__(self, args):
        ...
        self._model = ResNet(layers, args)
        if args.pretrained_on_imagenet:
            load_pretrained_weights(self._model, load_pretrained_model("resnet152"))
