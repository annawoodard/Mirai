...
def inflate_model(
    model, time_dim=1, time_padding=0, time_stride=1, time_dilation=1, center=False
):
    """
    args:
...
def inflate_conv(conv2d, time_dim, time_padding, time_stride, time_dilation, center):
    """
    args:
...
def inflate_linear(
    linear2d, time_dim, time_padding, time_stride, time_dilation, center
):
    """
    args:
...
def inflate_batch_norm(
    batch2d, time_dim, time_padding, time_stride, time_dilation, center
):
    """
    args:
    - batch2d: BatchNorm2d
...
def inflate_pool(pool2d, time_dim, time_padding, time_stride, time_dilation, center):
    """
    args:
    ...
    if isinstance(pool2d, torch.nn.MaxPool2d):
        ...
        pool3d = nn.AvgPool3d(
            kernel_dim, padding=padding, stride=stride, ceil_mode=pool2d.ceil_mode
        )
    else:
